...
const AddUser = () => {
  const {personData ,setPersonData,name,setName,age,setAge,id} = useContext(UserContex);
  ...
  return (
    ...
    <section className="w-full flex items-center justify-center mt-5">
      <form className="w-3/5 flex flex-col gap-3 items-center">
        ...
        <div className="w-4/5">
          <Button type="button" className='bg-green-500 w-full' handleClick={()=>{handleAddUser()}} />
        </div>
      </form>
      </section>
    </>
